...
export default function News() {
    ...
    return (
        <>
            <Helmet>
                <title>RAIN - Notícias</title>
                <meta name="description" content="Notícias sobre desastres naturais em tempo real com dados de satélite, radares meteorológicos e sensores em campo. Layers de chuva, vento, temperatura e pressão. Mapas de calor e alertas de desastres" />
            </Helmet>
