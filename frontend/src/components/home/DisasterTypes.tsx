...
const disasters = [
  {
    ...
    description:
      "Chuvas intensas podem fazer rios, córregos e sistemas de drenagem transbordarem, inundando ruas, casas e áreas rurais.",
    icon: Droplets,
    color: "text-blue-500",
  ...
  },
  {
    ...
    description:
      "O excesso de chuva pode deixar encostas instáveis, provocando o deslizamento repentino de terra, pedras e vegetação.",
    icon: MountainSnow,
  ...
  },
  {
    title: "Secas Severas",
    description:
      "Longos períodos sem chuva reduzem reservatórios, prejudicam a agricultura e aumentam o risco de falta d’água. A seca também favorece queimadas, perdas econômicas e impactos na saúde da população.",
    icon: SunMedium,
  ...
  },
  {
    ...
    description:
      "Rajadas de vento muito fortes podem derrubar árvores, destelhar casas, interromper o fornecimento de energia e bloquear estradas. Em casos mais intensos, há risco de destruição de estruturas e ferimentos.",
    icon: Tornado,
    color: "text-cyan-500",
    image: TORNADO,
  },
  {
    ...
    description:
      "Temperaturas muito acima do normal por vários dias aumentam o risco de desidratação, insolação e problemas de saúde, especialmente em crianças e idosos. Também podem causar sobrecarga na rede elétrica e escassez de água.",
    icon: SunMedium,
    color: "text-red-500",
    image: CALOR,
  },
                    ...
                    <Card className="bg-surface/70 backdrop-blur-2xl shadow-xl shadow-black/10 border-border-custom hover:border-slate-500/40 hover:bg-surface/90 hover:shadow-2xl hover:shadow-blue-900/20 transition-all duration-500 relative overflow-hidden group h-full flex flex-col rounded">
                      ...
                      <div className="flex-1 p-6 md:p-8 flex flex-col relative z-10 bg-surface -mt-1 group-hover:bg-transparent transition-colors duration-500">
                        ...
                        <CardContent className="p-0 flex flex-col flex-1 justify-between z-10 relative">
                          <CardDescription className="text-slate-400 font-mono text-base md:text-md leading-relaxed group-hover:text-slate-300 transition-colors duration-300">
                            {disaster.description}
                          </CardDescription>

                          <button
                            onClick={() => { navigate('guia') }}
                            className="pt-6 flex items-center gap-2 text-blue-400 font-semibold group/btn cursor-pointer hover:text-blue-300 transition-colors">
                            Saiba mais
